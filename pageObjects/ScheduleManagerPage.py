...
class ScheduleManager(MainPage):
    ...
    RADIO_BUTTON = (By.XPATH, "//body/div[@id='app']/div[@class='content-div']/div[@class='dialog-container']/div[@class='dialog publish-dialog ui-draggable']/div[@class='dialog-content']/div[@class='dialog-body']/div[@class='radio-group-container']/div[2]/div[1]")
    CREATING = (By.LINK_TEXT, "Creating")
    GENERATING = (By.LINK_TEXT, "Generating")
    ...
    def NewSchedule(self):
        ...
        self.wait_until_invisible(self.CREATING)
        ...
        self.is_element_visible(self.RADIO_BUTTON)
    ...
    def NewAutoGeneratedSchedule(self):
        ...
        self.wait_until_invisible(self.GENERATING)
